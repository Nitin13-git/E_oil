  ...
  const features = [
    {
      ...
      description: 'All our products are made from pure, natural ingredients with no synthetic additives.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'We source the finest botanicals from trusted farms and distilleries around the world.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Every batch is tested for purity and potency with GC/MS analysis and COA documentation.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Eco-friendly packaging that protects our products and the planet.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Fast Shipping',
      description: 'Quick and reliable delivery to your doorstep with careful handling.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
