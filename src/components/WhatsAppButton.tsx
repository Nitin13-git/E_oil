...
const WhatsAppButton = () => {
    ...
    return (
        <Link
            ...
            className="fixed bottom-8 right-8 z-50 transition-transform hover:scale-110 active:scale-95 animate-bounce-subtle group"
            aria-label="Chat on WhatsApp"
        >
            <div className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                {/* Tooltip */}
